...
public class LeadDTO {
	...
	private String leadTrackStatus;
	...
	public String getLeadTrackStatus() {
		return leadTrackStatus;
	}

	public void setLeadTrackStatus(String leadTrackStatus) {
		this.leadTrackStatus = leadTrackStatus;
	}
